...
// nor the watchdog firing; node:vm used to release-assert on that (or, with a
// timeout option armed, misreport it as ERR_SCRIPT_EXECUTION_TIMEOUT) instead
// of letting the worker exit.
